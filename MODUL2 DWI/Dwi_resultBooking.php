...
<body>
    <nav class="navbar navbar-expand-sm bg-dark justify-content-center">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="Dwi_resultBooking.php">Booking</a>
            </li>
        </ul>
    </nav>
    ...
    $dated = isset($_['date']) ? $_['date'] : '';
    $time = isset($_['time']) ? $_['time'] : '';
    $duration = isset($_['duration']) ? $_['duration'] : '';
    $typeCar = isset($_['typeCar']) ? $_['typeCar'] : '';
    $phone = isset($_['phoneNumber']) ? $_['phoneNumber'] : '';
    $serv = isset($_['service']) ? $_POST['service'] : '';
